        ...
        <div className="mx-auto w-full max-w-7xl">
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                ...
                <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full ">
                    <img className="w-96" src="https://static.vecteezy.com/system/resources/previews/005/611/271/large_2x/web-development-concept-illustration-programmers-and-web-developers-are-working-to-create-passwords-sales-websites-and-web-analytics-flat-style-cartoon-illustration-free-vector.jpg  " alt="image1" />
                </div>
            </aside>
